...
sed -E -i -e '/[-@]ads|^regexp:|scholar\.google|crashlytics\.com|doubleclick\.net|gvt2\.com|\.goog|google\.com|googleadservices\.com|google-?analytics\.com|googleapis\.com|googletagmanager\.com|googletagservices\.com|recaptcha\.net$/d' -e 's/:@cn$//' -e 's/full://' -e 's/domain:/\*\./' 'tmp_whitelist.txt' 'tmp_scholar_not_cn.txt'
